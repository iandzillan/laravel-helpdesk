                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nik" value="{{ Auth::user()->employee->nik }}" disabled>
                                    <div class="invalid-feedback d-none" role="alert" id="alert-nik"></div>
                                </div>
                                <div class="form-group">
                                    <label for="name" class="form-label">Name</label>
                                    <input type="text" class="form-control" id="name" value="{{ Auth::user()->employee->name }}" disabled>
            ...
            $('#form-create-ticket').on('submit', function(e){
                ...
                $.ajax({
                    ...
                    success:function(response){
                        ...
                        let url    = "{{route('notification', ":ticket")}}";
                        ...
                        // reload page
                        setTimeout(() => {
                            window.location.href = "{{route('user.my.tickets')}}"
                        }, 2000);
                    }, 
                    error:function(error){
                        // show message
