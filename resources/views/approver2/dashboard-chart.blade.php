<script>
    $(document).ready(function(){
        ...
        $('#filter-bar').on('change', function(){
            ...
            switch (value) {
                case 'year':
                    let url1 = "{{ route('subdept.categorychart.year') }}";
                    ...
                    case 'month':
                        let url2 = "{{ route('subdept.categorychart.month') }}";
                ...
                case 'week':
                    let url3 = "{{ route('subdept.categorychart.week') }}";
        ...
        let url4 = "{{ route('subdept.subcategorychart.year') }}";
        ...
        $('#filter-donut').on('change', function(){
            ...
            switch (value) {
                case 'year':
                    let url5 = "{{ route('subdept.subcategorychart.year') }}";
                ...
                case 'month':
                    let url6 = "{{ route('subdept.subcategorychart.month') }}";
                ...
                case 'week':
                    let url7 = "{{ route('subdept.subcategorychart.week') }}";
